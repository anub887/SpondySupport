...
// ADDITION 1: Helper function to send an event to Google Analytics
const trackEvent = (eventName) => {
  // Check if the gtag function is available on the window object
  if (window.gtag) {
    window.gtag('event', eventName, {
      'event_category': 'Engagement',
      'event_label': 'Chatbot Click',
    });
  } else {
...
const resources = [
  // ... your resources array remains the same
  {
    type: "article",
      ...
      <main className="flex flex-col items-center mt-20 px-4">
        <div className="w-full max-w-2xl p-8 rounded-2xl shadow-lg text-center bg-gradient-to-br from-gray-50 to-gray-200 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
          ...
          <a
            ...
            // ADDITION 2: The onClick handler that triggers the tracking function
            onClick={() => trackEvent('open_chat_click')}
          >
